...
# Kestrel: adopted from utah-packages (same 140.13.0 tree). rust 1.98 added
# the *-oe-linux-gnu targets, which leaves moz.configure unable to narrow
# x86_64-redhat-linux-gnu down to one rust target. Not in rawhide, which has
# not rebuilt this package since that rust landed.
