...
# Upstream: https://gitlab.gnome.org/GNOME/adwaita-fonts.git (tag 51.0).
...
%prep
%autosetup -n adwaita-fonts-51.0
...
%changelog
* Fri Sep 18 2026 Kestrel <kestrel@localhost> - 51.0-1.hum1.rpmfactory
