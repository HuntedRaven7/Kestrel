...
# Upstream: https://gitlab.freedesktop.org/pipewire/rtkit (tag v0.14).
...
Source0:          https://gitlab.freedesktop.org/pipewire/rtkit/-/archive/v0.14/rtkit-0.14.tar.gz
...
%changelog
* Fri Sep 18 2026 Kestrel <kestrel@localhost> - 0.14-1.hum1.rpmfactory
