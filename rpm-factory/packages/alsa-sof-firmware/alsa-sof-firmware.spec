...
find -P . -name "*.tplg.xz" | sed -e '/^.$/d' >> $FILEDIR/alsa-sof-firmware.files
...
%changelog
* Sat Sep 19 2026 Kestrel <kestrel@localhost> - 2025.12.2-3.hum1.rpmfactory
...
* Fri Sep 18 2026 Kestrel <kestrel@localhost> - 2025.12.2-2.hum1.rpmfactory
